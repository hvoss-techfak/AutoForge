...
def main():
    ...
    parser.add_argument("--output_size", type=int, default=1024, help="Maximum dimension of output image")
    parser.add_argument("--solver_size", type=int, default=128, help="Maximum dimension of image used for optimization")
